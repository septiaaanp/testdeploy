        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Input Biaya Gaji <?php echo $tampil2['nama_perusahaan'];?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    <div class="box-body">     
                                ...
                                <div id="text" style="display:none"> 
                                  ...
                                  width="50%">
                                    ...
                                    <tbody>
                                      <td width="30%">
                                        <div class="form-group ">
                                          <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="jumlah_pkd" placeholder="Jumlah...">
                                        </div> 
                                      </td>
                                      <td width="30%">
                                        <div class="form-group ">
                                          <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="tunj_pkd" placeholder="Tunjangan PKD...">
                                        </div> 
                                      </td>
                                    </tbody>
                                  </table>
    ...
    <!-- /.content -->
      ...
      { 
        foreach($_POST['jabatan'] as $key1 => $jabatan){
          ...
          // $ambil= $koneksi->query ("SELECT * FROM tbl_kontrakclient where nama_perusahaan = '$id_kontrak'");
        ...
        echo "<script>location='index.php?halaman=selanjutnya2&client=$nama';</script>";
