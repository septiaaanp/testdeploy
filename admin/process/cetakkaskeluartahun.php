...
$ambil = $koneksi->query("SELECT * FROM tbl_kaskeluar where substr(tanggal,1,4)= '$tahun' order by tbl_kaskeluar.tanggal");
$ambil2 = $koneksi->query("SELECT * FROM tbl_kaskeluar where substr(tanggal,1,4)= '$tahun' order by tbl_kaskeluar.tanggal");
$jumlah_kas_tahun = $ambil2->num_rows;

if($jumlah_kas_tahun < 1){
    ...
    $ambil3= $koneksi->query ("SELECT SUM(total_harga) AS total FROM tbl_kaskeluar where substr(tanggal,1,4)= '$tahun'");
