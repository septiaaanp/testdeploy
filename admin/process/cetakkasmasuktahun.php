...
$ambil = $koneksi->query("SELECT * FROM tbl_kasmasuk where substr(tanggal,1,4)= '$tahun' order by tbl_kasmasuk.tanggal");
$ambil2 = $koneksi->query("SELECT * FROM tbl_kasmasuk where substr(tanggal,1,4)= '$tahun' order by tbl_kasmasuk.tanggal");
...
if($jumlah_kas_tahun < 1){
    ...
    $ambil3= $koneksi->query ("SELECT SUM(total_harga) AS total FROM tbl_kasmasuk where substr(tanggal,1,4)= '$tahun'");
