  ...
  <style>
    ...
    <section class="content-header">
      <h1>
        Transaksi
        <small>Gaji Personil</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Transaksi</li>
        <li class="active">Gaji Personil</li>
      </ol>
    </section>
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="?halaman=lihatgajiPersonil&client=<?php echo $tampil['nama_perusahaan'];?>" class="btn btn-success btn-sm">
                            Lihat List Personil
                         </a>
                      </td>
                  </tr>
