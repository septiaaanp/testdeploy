                    ...
                    <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo indonesian_date($tampil3['tgl_absensi'], 'd F Y');?></td>
                                ...
                                <td>
                                    ...
                                    <a href = "?halaman=hapusabsensi&id=<?php echo $tampil3['id_absensi']; ?>" class = "btn btn-danger btn-sm" onclick="javascript: return confirm('Apakah anda yakin menghapus data tersebut?')"><span class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                            <?php $nomor++; ?>
                            <?php } ?>
