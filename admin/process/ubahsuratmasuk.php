            ...
            <div class="box-body">
              <form role="form" autocomplete="off" method="POST" enctype = "multipart/form-data">
                ...
                <div class="form-group float-label-control">
                  ...
                  <input type="text" class="form-control" name="pengirim" value="<?php echo $tampil ['pengirim'];?>" required>
                </div>
                <!-- Date -->
                <div class="form-group" >
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" name="tgl_masuk" id="datepicker" value="<?php echo date('d-m-Y', strtotime($tampil['tgl_masuk'])); ?>" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- Date -->
                ...
                <div class="form-group float-label-control">
                  ...
                  <a href="../admin/process/SuratMasuk/<?php echo $tampil['upload'] ?>" target="_blank"><?php echo $tampil ['upload'];?></a>
      ...
      if (isset($_POST['save']))
        {   
            ...
            if (!empty ($lokasi))
            {
                ...
                $koneksi->query("UPDATE tbl_suratmasuk SET no_surat = '$no_surat', perihal = '$perihal', 
                pengirim = '$pengirim' , tgl_masuk = '$tgl_masuk', tgl_surat = '$tgl_surat', alamat = '$alamat',
                upload = '$nama' WHERE id_suratmasuk = '$_GET[id]'");
            }
            else
            {
                $koneksi->query("UPDATE tbl_suratmasuk SET no_surat = '$no_surat', perihal = '$perihal', 
