  ...
  <style>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="Active">Lihat Rekap Absensi Personil</li>
      </ol>
    </section>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <!-- /.box-header -->
        <form role="form" method="POST" target="_blank" action="../admin/process/cetakrekapabsensi.php?id=<?php echo $_GET['id']?>">
          ...
          <!-- /.row -->
          <div>
              <a href="?halaman=absensiPerusahaan" class="btn btn-warning pull-right" >
