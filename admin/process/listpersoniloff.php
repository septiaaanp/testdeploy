  ...
  <style>
    ...
    $ambil4 = $koneksi->query("SELECT * FROM tbl_kontrakhabis where id_presentasi = '$id_presentasi'");
    $tampil4 = $ambil4->fetch_assoc();
    $id_kontrak = $tampil4['id_kontrak'];

    $ambil3 = $koneksi->query("SELECT * FROM tbl_personiloff where id_presentasi = '$id_presentasi'");
    ...
    <section class="invoice">
        ...
        <div class="box-body">
            <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm " cellspacing="0"
              ...
              <tbody>
                <tr>
                <?php $nomor = 1; ?>
                      <?php $ambil = $koneksi->query("SELECT * FROM tbl_personiloff where id_presentasi = '$id_presentasi'");?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="../admin/process/cetaklistpersoniloff.php?id=<?php echo $tampil4['id_kontrak'];?>" target="_blank" 
