  ...
  <style>
                              ...
                              <div>
                                ...
                                <div class="row">
                                  <div class="col-md-3" id="text" style="display:none"> 
                                    <input type="text" onkeypress="return hanyaAngka(event)" class="form-control" name="libur" placeholder="Hari Libur Nasional...">
                                  </div>
                                </div>
                              </div>                             
    ...
    <!-- /.content -->
      ...
      { 
          ...
          $libur_nas = $hasil5['nilai_pendukung'];

          $libur_fix = $libur_nas * $libur;
          $koneksi->query ("UPDATE tbl_biayapendukung SET jumlah_libur = '$libur', nilai_pendukung = '$libur_fix' 
