  ...
  <style>
    ...
    <section class="content-header">
      <h1>
        Data Personil
        <small>Daftar Personil Aktif</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Data Personil</li>
        <li class="active">Daftar Personil Aktif</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="dtHorizontalVerticalExample" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <tbody>
                  <?php $nomor = 1; ?>
                    <?php $ambil = $koneksi->query("SELECT tbl_presentasiclient.nama_perusahaan , tbl_daftarpersonil.* FROM 
                      tbl_presentasiclient, tbl_daftarpersonil WHERE 
                      tbl_presentasiclient.id_presentasi = tbl_daftarpersonil.id_presentasi");?>
                    ...
                    <tr>
                        ...
                        <td> 
                          <!-- <a href = "../admin/process/strukgaji.php?id=<?php echo $tampil ['id_personil'];?>" target="_blank" class = "btn btn-primary btn-sm"><span class="fa fa-print"></span></a> -->
                          <a href = "?halaman=ubahdaftarpersonil&id=<?php echo $tampil ['id_personil']; ?>" class = "btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
              ...
              <div class="box-footer ">
                <a class="btn btn-primary" href="?halaman=tambahDaftarPersonil" role="button">Tambah Data</a>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
