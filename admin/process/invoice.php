  ...
  <style>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <!-- /.box-header -->
        <form role="form" method="POST" target="_blank" autocomplete="off" action="../admin/process/cetakinvoice.php?id=<?php echo $_GET['id']?>">
                <div class="box-body col-md-4">
                 <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>No. Invoice</label>
                            <input type="text" name="invoice" onkeypress="return hanyaAngka(event)" placeholder="Tulis No Invoice" class="form-control" required>
                        </div>
                    <!-- /.form-group -->
                    </div>
